            ...
            <div class="col-lg-6 offset-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{route('admin#updateCategory',$category->id)}}" method="post" novalidate="novalidate">
                            @csrf
                            <div class="form-group">
                                <label for="cc-payment" class="control-label mb-1">Category Name</label>
                                <input id="cc-pament" name="name" type="text" class="form-control @error("name") is-invalid

                                @enderror" aria-required="true" aria-invalid="false" value="{{old('name',$category->name)}}" placeholder="e.g. Seafood..." >
                            @error('name')
